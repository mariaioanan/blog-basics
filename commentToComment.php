...
if (isset($_POST['submit'])){   
    ...
    $sql="insert into`comments` (user_name,email,comment,posts_id,parent_comment_id) values('$user_name','$email','$comment','$post_id','$parent_comment_id')";
...
<header>
    <div class="container my-5">
        <form method="POST" class="form" action="comment.php">
            ...
            <input hidden value='<?php echo $_GET["parent_comment_id"] ?>' name="parent_comment_id">
